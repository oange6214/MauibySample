...
public partial class ControlDemo : ContentPage
{
    ...
    {
        sliderLabel.Text = $"People Attending {Convert.ToInt32(e.NewValue)}";
    }

    private void stepper_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        stepperLabel.Text = $"People Attending {Convert.ToInt32(e.NewValue)}";
    }
    ...
    private void Steelers_ItemSelected(object sender, SelectedItemChangedEventArgs e)
    {
        ...
        switch (e.SelectedItem)
        {
            case ListModel m when m.Name.StartsWith("Cameron"):
                ...
                playerData = "Five-tie Pro Bowler (2018, 2019, 2020, 2021, 2022)";
                break;
            ...
            case ListModel m when m.Name.StartsWith("Minkah"):
                ...
                playerData = "314 tackles (212 solo), 33 passes defenssed, 13 interceptions, 5 tackles for loss, 4 fumble recoveries, four forced fumbles, 33 interception returns for TDs";
                break;
            case ListModel m when m.Name.StartsWith("Najee"):
                player = "Najee Harris";
                playerData = "1,200 rusing yards and seven rushing touchdowns on 307 attempts and added 74 catches for 397 receiving yards and three recieving touchdowns as a rookie";
                break;
        ...
        DisplayAlert($"{player}", $"{playerData}", "Out");
    }
}